...
class TestIntegration(unittest.TestCase):
    ...
    def test_logical_streams_from_pg_with_hard_delete_mapping(self):
        ...
        expected_table_two = [
            ...
            {'cid': 9, 'cvarchar': "updated row"},
            {'cid': 10, 'cvarchar': 'updated row'},
            {"cid": 11, "cvarchar": None},
            {"cid": 12, "cvarchar": None},
            {"cid": 13, "cvarchar": None},
            {"cid": 14, "cvarchar": None},
            {"cid": 15, "cvarchar": None},
            {"cid": 16, "cvarchar": None},
            {"cid": 17, "cvarchar": None},
            {"cid": 18, "cvarchar": None},
            {"cid": 19, "cvarchar": None},
            {"cid": 20, "cvarchar": None},
        ]
